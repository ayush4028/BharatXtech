...
const Menubar = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex h-full w-60 items-center  rounded-md  bg-white p-1 mr-10 shadow-sm dark:border-neutral-800 dark:bg-neutral-950  ",
      className
    )}
    {...props} />
))
...
const MenubarTrigger = React.forwardRef(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex items-center justify-center h-full w-full border border-black rounded-md py-5  text-xl",
      className
    )}
    {...props} />
))
